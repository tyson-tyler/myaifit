        ...
        <div className="flex gap-3 relative h-fit items-stretch">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              deficit by eating nutrient-dense whole foods that are low in
        ...
        <div className="flex gap-3 relative h-fit items-stretch">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              loss success is attributed to exercise. Incorporate a mix of
        ...
        <div className="flex gap-3 relative h-fit items-stretch">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              each night and practice stress-reducing techniques such as
