      ...
      <div className="flex flex-col gap-20">
        ...
        <div className="flex flex-col gap-3">
          ...
          <span className="text-neutral-400 text-sm font-normal">
            MyaiFit Workout Program for You (2 days workout as you requested)
          </span>
        </div>
    ...
    return (
      <div className="flex flex-col gap-20">
        ...
        <div className="flex flex-col gap-3">
          <h2 className="font-bold text-4xl flex-shrink-0">Exercise plan</h2>
          <span className="text-neutral-400 text-sm font-normal">
            MyaiFit Workout Program for You (3 days workout as you requested)
          </span>
        </div>
    ...
    return (
      <div className="flex flex-col gap-20">
        ...
        <div className="flex flex-col gap-3">
          <h2 className="font-bold text-4xl flex-shrink-0">Exercise plan</h2>
          <span className="text-neutral-400 text-sm font-normal">
            MyaiFit Workout Program for You (4 days workout as you requested)
          </span>
        </div>
    ...
    return (
      <div className="flex flex-col gap-20">
        ...
        <div className="flex flex-col gap-3">
          <h2 className="font-bold text-4xl flex-shrink-0">Exercise plan</h2>
          <span className="text-neutral-400 text-sm font-normal">
            MyaiFit Workout Program for You (5 days workout as you requested)
          </span>
        </div>
  ...
  return (
    <div className="flex flex-col gap-20">
      ...
      <div className="flex flex-col gap-3">
        <h2 className="font-bold text-4xl flex-shrink-0">Exercise plan</h2>
        <span className="text-neutral-400 text-sm font-normal">
          MyaiFit Workout Program for You
        </span>
      </div>
